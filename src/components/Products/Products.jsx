...
const Products = ({productsPromise}) => {
    ...
    return (
        <div>
            ...
            {
                products.map(product => <div className='border-2 border-gray-300 rounded-2xl p-5 space-y-3'>
                    ...
                    <button className='btn btn-primary bg-[#8B2CFF] hover:bg-[#7006f1] w-full'>Buy Now</button>
                </div>)
            }
            </div>
        </div>
