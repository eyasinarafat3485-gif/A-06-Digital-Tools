...
const Banner = () => {
    return (
        <section className="min-h-[80vh] flex items-center justify-center bg-white px-6 md:text-start text-center md:px-16 py-14">
            <div className="mx-auto grid grid-cols-1 md:grid-cols-2 items-center justify-between">
                ...
                <div className="space-y-6 ">
                    ...
                    <button className="bg-[#8B2CFF] text-white px-3 py-1.5 md:px-7 md:py-4 rounded-full font-medium md:font-semibold hover:bg-[#7006f1] transition cursor-pointer">Explore Products
                    </button>

                    <button className='btn btn-outline px-3 py-1.5 md:px-10 md:py-7 text-[#8B2CFF] rounded-full font-medium md:font-semibold '><img src="Play.png" alt="" /> Watch Demo</button>
                    </div>
                </div>
